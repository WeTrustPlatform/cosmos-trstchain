...
var DefaultNodeHome = os.ExpandEnv("$HOME/.trstchain")
...
func main() {
	...
	executor := cli.PrepareBaseCmd(rootCmd, "TRSTChain", DefaultNodeHome)
...
func InitCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			fmt.Printf("Initialized TRSTChain configuration and bootstrapping files %s...\n", viper.GetString(cli.HomeFlag))
			return nil
		},
	}
...
$ trstchaind add-genesis-account cosmos1tse7r2fadvlrrgau3pa0ss7cqh55wrv6y9alwh 1000TRST
`),
